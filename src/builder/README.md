...
- **`clean_all()`**: `--clean` 옵션 사용 시 호출됩니다. `commands/`, `agents/`, `skills/` 디렉터리와 전역 파일(`GEMINI.md`, `CLAUDE.md`, `AGENTS.md`) 전체를 삭제합니다. Codex 타겟에서는 output-dir 외부의 `../.agents/skills/` 디렉터리도 함께 삭제합니다.
